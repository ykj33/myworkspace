...
public class BoardDAO {
	...
	public PageTO page(int curPage) {
		...
		try {
			...
			// 값을 넣어주면 종속변수의 값의 변화가 생긴다.
			// setter에 changevarval 메소드로 값의 변화를 주었기 때문.
			to.setAmount(amount);

			pstmt = conn.prepareStatement(sql);
			// ?를 채워주어야 하므로 to의 startnum과 endnum을 가져온다.
