			...
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="id">작성자</label> <input name="id" type="text"
						class="form-control" id="id" value="${login.id }" placeholder = "아이디는 익명으로 처리됩니다." readonly>
				</div>


			</div>
			<div class="form-group">
				<label for="title">제목</label> <input name="ftitle" type="text"
					class="form-control" id="title" placeholder="제목을 입력하세요."
					required="required">
			</div>
			<div class="form-group">
				<label for="content">내용</label>
				<textarea rows="10" name="fcontent" class="form-control" id="content"
